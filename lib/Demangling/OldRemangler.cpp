...
ManglingError Remangler::mangleArithmetic(Node *node, unsigned depth) {
  DEMANGLER_ASSERT(node->getNumChildren() == 3, node);
...
ManglingError Remangler::mangleArithmeticAdd(Node *node, unsigned depth) {
  DEMANGLER_ASSERT(node->getNumChildren() == 2, node);
  RETURN_IF_ERROR(mangle(node->getChild(0), depth + 1));
  RETURN_IF_ERROR(mangle(node->getChild(1), depth + 1));
  Buffer << "$Va";
...
ManglingError Remangler::mangleArithmeticSubtract(Node *node, unsigned depth) {
  DEMANGLER_ASSERT(node->getNumChildren() == 2, node);
  RETURN_IF_ERROR(mangle(node->getChild(0), depth + 1));
  RETURN_IF_ERROR(mangle(node->getChild(1), depth + 1));
  Buffer << "$Vs";
...
ManglingError Remangler::mangleArithmeticMultiply(Node *node, unsigned depth) {
  DEMANGLER_ASSERT(node->getNumChildren() == 2, node);
  RETURN_IF_ERROR(mangle(node->getChild(0), depth + 1));
  RETURN_IF_ERROR(mangle(node->getChild(1), depth + 1));
  Buffer << "$Vm";
...
ManglingError Remangler::mangleArithmeticDivide(Node *node, unsigned depth) {
  DEMANGLER_ASSERT(node->getNumChildren() == 2, node);
  RETURN_IF_ERROR(mangle(node->getChild(0), depth + 1));
  RETURN_IF_ERROR(mangle(node->getChild(1), depth + 1));
  Buffer << "$Vd";
